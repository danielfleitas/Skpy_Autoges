"""
Django settings for skpy_autogest_project project.
...
SECRET_KEY = 'django-insecure-005o$^h^c3!h#@u)n3c9--nd6_h7tt9mib!gh38n%@_zwhex=!'
...
ROOT_URLCONF = 'skpy_autogest_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'skpy_autogest_project.context_processors.apariencia_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'skpy_autogest_project.wsgi.application'
...
# Agrega esta línea para definir la ruta de los archivos estáticos
STATICFILES_DIRS = [
